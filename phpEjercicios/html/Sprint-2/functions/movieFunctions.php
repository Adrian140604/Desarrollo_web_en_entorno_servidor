...
function viewButton($accion, $movie) {
    if ($accion === "vermas") {
        echo "
             <div class=\"row mb-3\">
                <div class=\"col-md-3 offset-md-3 d-flex justify-content-start\">
                    <a class=\"btn btn-outline-dark my-1 me-1\" href=\"./listCast.php?cip={$movie}\">Ver reparto</a>
                </div>        
                <div class=\"col-md-3 d-flex justify-content-end\">
                    <a href=\"./showMoviesList.php\"class=\"btn btn-primary my-1\">Volver</a>
                </div>
            </div>";
...
function showCast($connection) {
    ...
    if ($result) {
        ...
        print "<a class=\"btn btn-outline-primary my-1\" href=\"./showMoviesList.php\">Volver</a> ";
    } else {
